...
public class CreateSaleHandlerTests
{
    ...
    [Fact(DisplayName = "Given valid sale data When creating sale Then returns success response and publishes event")]
    ...
    {
        // Given
        var command = new CreateSaleCommand(); // Empty fields will fail validation
